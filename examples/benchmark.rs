...
//!
//! Run with: cargo run --example benchmark --release --features dev-certs
...
async fn main() -> std::io::Result<()> {
    ...
    #[cfg(feature = "dev-certs")]
    {
        ...
        println!();
        println!("┌─────────────────────────────────────────┐");
        println!("│  Latência (RTT com criptografia):       │");
        println!("├─────────────────────────────────────────┤");
        println!("│  Mínima:   {:>10.3}µs                 │", min.as_nanos() as f64 / 1000.0);
        println!("│  Média:    {:>10.3}µs                 │", avg.as_nanos() as f64 / 1000.0);
        println!("│  Mediana:  {:>10.3}µs                 │", median.as_nanos() as f64 / 1000.0);
        println!("│  P99:      {:>10.3}µs                 │", p99.as_nanos() as f64 / 1000.0);
        println!("│  P99.9:    {:>10.3}µs                 │", p999.as_nanos() as f64 / 1000.0);
        println!("│  Máxima:   {:>10.3}µs                 │", max.as_nanos() as f64 / 1000.0);
        println!("└─────────────────────────────────────────┘");
